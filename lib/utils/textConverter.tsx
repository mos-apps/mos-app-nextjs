...
// markdownify
export const markdownify = (content: any, tag: any, className: any) => {
  if (!content) return null;
...
// humanize
export const humanize = (content: any) => {
  if (!content) return null;

  return content
    .replace(/^[\s_]+|[\s_]+$/g, "")
    .replace(/[_\s]+/g, " ")
    .replace(/^[a-z]/, function (m:any) {
...
const htmlEntityDecoder = (htmlWithEntities: any) => {
  let entityList:any = {
    "&nbsp;": " ",
    "&lt;": "<",
    "&gt;": ">",
